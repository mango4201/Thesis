...
%
% PROJECTION. R1, R2 and R3 delivered and MEASURED after the checker
% pass and the final coherence pass of 2026-08-27:
%     R1 1.68 + R2 2.95 + R3 2.05 measured = 6.68 pg for Ch4 so far,
%     + R4 2.1 + R5 1.2 projected  =  9.98 pages.
...
% (see its provenance header). Body projects ~51, inside the 40-60
% rule. The remaining lever is R5 near 200 words.
